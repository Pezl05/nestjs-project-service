...
OTEL_RESOURCE_ATTRIBUTES=<Resource attributes, e.g., service.name=project-service>
...
Initialize the database first and the Authentication Service must be set up before.
[[Go Auth Service](https://github.com/Pezl05/go-auth-service)]
```Docker-compose file
